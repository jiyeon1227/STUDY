...
//독립 객체들도 내부적으로는 사방에 흩어져 존재 하지만 입.출력 할때는 줄을 세워서 입.출력 하기 때문에 객체 직렬화라함
...
// Serializable 인터페이스를 구현한 클래스로 객체를 만들고 입.출력을 하면 우리가 프로그램에서 체크하지 않아도 중복된 객체가 입.출력하는 것을 방지해 준다.
