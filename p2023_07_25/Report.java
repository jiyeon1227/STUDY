...
//111111-1111118 -> 올바른 주민번호

import java.io.InputStream;
import java.util.Scanner;

public class Report {//JuminCheck01
...
//		JuminCheck01 jc = new JuminCheck01();
		...
		Scanner sc = new Scanner(is);//InputStream으로된 생성자를 호출해서 사용함

		System.out.println("주민번호 앞자리를 입력 하세요?");
		String jumin1 = sc.next(); // 900101 -> nextInt로 받으면 length()메서드를 사용할 수 없음
